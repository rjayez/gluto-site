<template>
  <div id="side-menu" class="border-solid shadow-lg
        bg-indigo-950 pl-3 text-gray-100 font-bold text-indigo-150 fixed top-0 left-0">
    <div class="-mt-20">
      <img src="../assets/logo.png" alt="Logo du streamer Tetryl"/>
    </div>

    <div>
      <div class="py-2 flex cursor-pointer group" @click="go('')">
        <div class="flex justify-end w-1/5 pr-3 h-6">
      ...
      <div class="menu-item group" @click="go('planning')">
        <div class="flex justify-end w-1/5 pr-3">
