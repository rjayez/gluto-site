<template>
  ...
  <div style="position: absolute; left: 50%">
    <div class="ff7 premier" style="position: relative; left: -50%; opacity: 0">
      <h1>Glutobox</h1>
  ...
  <div style="position: absolute; left: 50%">
    <div class="ff7 second" style="position: relative; left: -50%; opacity: 0">
      <h1>Glutobox</h1>
      <p>Joli tirage {{ pseudo }} ! Ces cartes sont maintenant disponibles dans ta collection !</p>
    </div>
  </div>
</template>
